...
def run_pipeline(config: PipelineConfig) -> None:
    ...
    metadata = {
        ...
        "device": str(device),
        "total_time_seconds": round(pipeline_elapsed, 2),
        "svd_top_k": config.svd.top_k,
        "tda_downsample": config.tda.downsample_factor,
        "smt_enabled": config.spectral.enable_smt_verification,
        "pruning_threshold": config.pruning.importance_percentile,
        "structured_pruning": config.pruning.structured_pruning,
        "original_params": compression_report.original_total_params,
        "kept_params": compression_report.kept_total_params,
        "compression_ratio": round(compression_report.compression_ratio, 6),
        "verified_circuits": verification_report.verified_circuits,
        "total_circuits_analyzed": verification_report.total_circuits_analyzed,
        "concepts_extracted": concept_table.total_concepts_extracted,
        "spike_count": concept_table.global_spike_count,
        "betti_0": topology_result.persistence_diagram.betti_0,
        "betti_1": topology_result.persistence_diagram.betti_1,
        "output_files": {
